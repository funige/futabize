<?php
/*
  * Template - futabize by funige  >> https://poti-k.info/
  *
...
//メインのテンプレートファイル
define('MAINFILE', "futabize_main.html");

//レスのテンプレートファイル
define('RESFILE', "futabize_main.html");

//その他のテンプレートファイル
define('OTHERFILE', "futabize_other.html");

//お絵かきのテンプレートファイル
define('PAINTFILE', "futabize_paint.html");

//カタログのテンプレートファイル
define('CATALOGFILE', "futabize_catalog.html");
